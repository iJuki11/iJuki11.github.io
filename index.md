...
<body>
    ...
    <div id="cosmic-paradox" class="project">
        ...
        <ul>
    <strong><li>VFX:Created UI effects and the majority of in-game visual effects</li>
    ...
    <li><strong>Visual Identity:</strong> Developed the game’s overall visual identity, ensuring consistency across all visual elements</li></strong>
    <br>
    <br>
    <br>
</ul>
